...
/***/ function(module, exports, __webpack_require__) {
	...
	var _debug2 = __webpack_require__(1);
	
	var _debug3 = _interopRequireDefault(_debug2);
	
	_debug3['default'].enable('*');
	
	var _debug = (0, _debug3['default'])('Hub');
	...
	var Hub = (function () {
	  function Hub(opts) {
	    ...
	    var self = this;
	    var makeClientFunc = function makeClientFunc(taskName) {
	      return function () {
	  ...
	  _createClass(Hub, [{
	    ...
	    value: function check() {
	      ...
	      if (this.readyStatus) {
	        ...
	        this.queue.map(function (t) {
	          _this2.task(t.taskName, t.params, t.callback);
	        });
	      } else {
	    ...
	    key: 'register',
	    value: function register(taskName, callback) {
	    ...
	    key: 'task',
	    value: function task(taskName, params, callback) {
	      if (this.readyStatus) {
	        ...
	        this.queue.push({ taskName: taskName, params: params, callback: callback });
	      }
	    }
	  }]);
